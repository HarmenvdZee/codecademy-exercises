...
describe("User visits root", () => {
  describe("Posting a quote", () => {
    it("Saves quote and metadata submitted by user", () => {
      ...
      assert.include(browser.getText("text[id=quotes]"), quote);
      assert.include(browser.getText("text[id=quotes]"), attributed);
      assert.include(browser.getText("text[id=quotes]"), source);
    });
  });
});
